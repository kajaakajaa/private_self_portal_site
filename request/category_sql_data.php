...
EOF;
    ...
    $array['contents_nobr'] = $array['contents_nobr'];
    $array['contents_nobr'] = nl2br($array['contents_nobr'], false);
    //編集コンテンツをhtmlspecialchars_decodeで復元
    $array['category']['contents'] = hd($array['category']['contents']);
  ...
  EOF;
    ...
    $stmt->bindParam(':contents', h($contents), PDO::PARAM_STR);
    $stmt->execute();
